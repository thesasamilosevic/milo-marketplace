...
These two pair up: the Weekly Planning Run does the analytical pick, the Life Mentor runs the reflective conversation around it.

## Setup

Weekly Planning Run needs a connected task database (Notion action items) and optionally a time source (Rize). Life Mentor reads a public Coaching Questions & Tools library over the web, no connection required.
